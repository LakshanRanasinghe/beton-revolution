	...
	<div class="beton-footer-wrapper container text-white pt-5">
		<div class="footer-logo pb-5">
			...
			<a href="<?php echo site_url(); ?>" class="custom-logo-link" rel="home" aria-current="page"><img width="278"
					height="55"
					src="<?php echo site_url(); ?>/wp-content/uploads/2025/03/mobielebetoncentrale-logo-optimized-footer.png"
					class="custom-logo" alt="Beton" decoding="async"></a>
		</div>
	...
	<div class="site-info border-top-gray">
		<div class="container py-4 text-center text-sm-start light-blue text-15 text-sm-14 poppins-400">
			<div class="row justify-content-between align-items-center">
				<div
					class="col-12 col-sm d-flex justify-content-center justify-content-sm-start align-items-center mb-2 mb-sm-0">
					<p class="mb-0 poppins-400 text-15 text-sm-14"><?php _e('Copyright © 2024', 'beton'); ?></p>
					&nbsp;
					<a href="<?php echo site_url(); ?>" class="light-blue link-hover">Mobielebetoncentrale.nl</a>
				</div>
