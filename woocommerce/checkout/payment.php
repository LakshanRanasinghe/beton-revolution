...
<div id="payment" class="woocommerce-checkout-payment">
	<div class="checkout-box mb-4">
		...
		<div class="checkout-content-wrapper checkout-payment-wrapper d-none">
			...
			<?php endif; ?>
			<button type="button" class="w-100 oswald-600 text-sm-20 text-white text-uppercase border-2 border-orange bg-orange rounded-0 px-6 py-2 mb-3" id="checkout-payment-confirm">Continue</button>
		</div>
	</div>
