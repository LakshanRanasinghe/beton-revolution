...
<div id="payment" class="woocommerce-checkout-payment">
	<div class="checkout-box mb-4 no-top-border-radius" id="woocommerce-checkout-payment-methods-wrapper">
		<div class="checkout-content-wrapper checkout-payment-wrapper d-none">
			<hr class="text-light-gray mt-0">
	...
	<div class="form-row place-order checkout-box mb-4 ">
		<div class="checkout-confirmation-title-wrapper d-flex justify-content-between align-items-center mb-3">
			<div class="before-collapse-title">
				<h2><?php esc_html_e('Bevestiging', 'beton'); ?></h2>
			</div>
			<div class="after-collapse-title d-none">
				<div class="d-flex align-items-center">
					<h4 class="mb-0 me-2"><?php esc_html_e('Bevestiging', 'beton'); ?></h4>
				</div>
			</div>
