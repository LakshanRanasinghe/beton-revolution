...
<div class="bg-image container-fluid object-fit-cover position-relative p-0" style="background-image: url('https://images.unsplash.com/photo-1541888946425-d81bb19240f5?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'); height: 90vh;">
    ...
    <div class="container h-100 d-flex flex-column justify-content-center">
        ...
        <div class="z-1 position-relative p-2 d-flex w-100 mb-2" style="backdrop-filter: blur(25px); background-color: #FFFFFF1A;">
        ...
        <div class="z-1 position-relative">
            <button class="oswald-600 text-20 text-white text-uppercase border-2 border-white rounded-0 bg-transparent px-4 py-3">Calculate Price</button>
            <button class="oswald-600 text-20 text-white text-uppercase border-2 border-orange bg-orange rounded-0 px-6 py-3">Free Quote</button>
        </div>
    </div>
</div>
