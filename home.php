...
<div class="bg-image container-fluid object-fit-cover position-relative p-0" style="background-image: url('https://images.unsplash.com/photo-1541888946425-d81bb19240f5?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'); height: 90vh;">
    ...
    <div class="container h-100 d-flex flex-column justify-content-center">
        ...
        <div class="row col-5 z-1 position-relative p-2 d-flex mb-4" style="backdrop-filter: blur(25px); background-color: #FFFFFF1A;">
            <h1 class="oswald-500 display-3 text-56 m-0 text-white text-uppercase">Pouring Concrete?</h1>
        </div>

        <div class="row col-9 z-1 position-relative p-2 mb-4" style="backdrop-filter: blur(25px); background-color: #FFFFFF1A;">
            <h1 class="oswald-500 display-3 text-76 m-0 text-white text-uppercase">Calculate your price here</h1>
...
<div class="bg-dark-blue container-fluid py-5 px-0">
    <div class="container">
        ...
        <div class="row pt-5">
            <div class="col-3">
                <div class="row">
                    <img class="image-fluid col-8" src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=2080&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="">
                    <div class="col-1 h-1" style="background-color: #FDD401;"></div>
                    <div class="col-1 h-1" style="background-color: #FDD40199;"></div>
