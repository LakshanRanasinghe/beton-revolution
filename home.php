...
<div class="bg-image container-fluid object-fit-cover position-relative p-0" style="background-image: url('https://images.unsplash.com/photo-1541888946425-d81bb19240f5?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'); height: 90vh;">
    ...
    <div class="container h-100 d-flex flex-column justify-content-center">
        <div class="row col-4 z-1 position-relative p-2 mb-4" style="backdrop-filter: blur(25px); background-color: #FFFFFF1A;">
            <div class="row col-8">
        ...
        <div class="row gap-3 z-1 position-relative">
            <button class="col-2 oswald-600 text-20 text-white text-uppercase border-2 border-white rounded-0 bg-transparent px-4 py-3">Calculate Price</button>
            <button class="col-2 oswald-600 text-20 text-white text-uppercase border-2 border-orange bg-orange rounded-0 px-6 py-3">Free Quote</button>
        </div>
    </div>
</div>
...
<div class="bg-white container-fluid py-5 px-0">
    <div class="container">
        <div class="row">
            <div class="col-7 z-1 position-relative p-2 mb-2" style="backdrop-filter: blur(25px); background-color: #FFFFFF1A;">
                <div class="col-8">
                    <h1 class="oswald-500 display-3 text-40 m-0 text-black text-uppercase mb-1">How do you pour concrete</h1>
                    <div class="p-2" style="background: linear-gradient(90deg, #FDD401 0%, rgba(253, 212, 1, 0) 100%);"></div>
                </div>
                <p class="grey-text poppins-400 text-18 line-height letterspace1 mt-3 mb-3">Pouring concrete yourself can result in a nice cost saving, but can also be a big failure. In the article how do I pour concrete? we show you the best method with the necessary tools.</p>
    ...
    <div class="container pt-5">
        <div class="row">
            ...
            <div class="col-7 z-1 position-relative p-2 mb-2 row align-items-center">
                <div class="row align-items-center col-12">
                    ...
                    <p class="grey-text poppins-400 text-18 line-height letterspace1 mt-3 mb-3">Can't see yourself pouring concrete yet ? No problem! For a sleek end result, you can opt for an all-in concrete pour. In that case, we take care of the entire pouring process. And you are assured of a successful concrete pour.</p>
                    ...
                    <p class="grey-text poppins-400 text-18 line-height letterspace1 mt-1 mb-3">Do you want to rent a concrete pump Or order concrete with pump? Calculate your price easily with our concrete calculator.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="bg-dark-blue container-fluid py-5 px-0">
    ...
    <div class="container">
        ...
        <div class="row pt-5">
            <div class="col-3">
                <div class="row col-12 h-full">
                    <img class="image-fluid col-8 p-0 me-2" src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=2080&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="">
                    <div class="col-1 h-1 me-2" style="background-color: #FDD401;"></div>
                    <div class="col-1 h-1 me-2" style="background-color: #FDD40199;"></div>
        ...
        <div class="row">
            <div class="container">
                <div class="row">
                    ...
                    <div class="p-0 col-5">
                        <img class="h-full" src="http://localhost/beton/wp-content/uploads/2024/11/4-Company-SK-withline.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="container">
                <div class="row">
                    <div class="col-5 p-0">
                        <img class="h-full" src="http://localhost/beton/wp-content/uploads/2024/11/4-Company-SK-flip-withline.png" alt="">
                    </div>
                    <div class="col-7 py-5">
                        <div class="row m-auto">
                            <div class="col-8">
