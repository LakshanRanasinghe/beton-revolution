...
$aantalTooltip = get_field('aantal_tooltip', 'option');
$locatieTooltip = get_field('locatie_tooltip', 'option');
$dateTooltip = get_field('gewenste_leveringsdatum_tooltip', 'option');
?>
            ...
            <div class="bpc-layout">
                ...
                <div class="bpc-card">
                        ...
                        <div class="bpc-step-inputs">
                            <div class="bpc-step-input-col">
                                <div class="bpc-step-input-header">
                                    ...
                                    <div class="bpc-step-input-icon">
                                        <?php if (!empty($aantalTooltip)) { ?>
                                            <a class="beton-popover text-success" tabindex="0" role="button"
                                                data-bs-toggle="popover" data-bs-trigger="focus" title="Hoeveel beton"
                                                data-bs-placement="top" data-bs-content="<?php echo $aantalTooltip; ?>">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <mask id="mask0_67_23_1" style="mask-type:alpha"
                            ...
                            <div class="bpc-step-input-col position-relative">
                                <div class="bpc-step-input-header">
                                    ...
                                    <div class="bpc-step-input-icon">
                                        <?php if (!empty($locatieTooltip)) { ?>
                                            <a class="beton-popover text-success" tabindex="0" role="button"
                                                data-bs-toggle="popover" data-bs-trigger="focus" title="Locatie"
                                                data-bs-placement="top" data-bs-content="<?php echo $locatieTooltip; ?>">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <mask id="mask0_67_23_2" style="mask-type:alpha"
                                                        maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                        <rect width="24" height="24" fill="#D9D9D9" />
                                                    </mask>
                    ...
                    <div class="bpc-section" id="bpc-section-uitvoering">
                        ...
                        <div class="bpc-section-head">
                            <div class="bpc-step-input-title">Uitvoering</div>
                            <div class="bpc-step-input-icon">
                                <?php
                                $allin_tooltip = get_field('all_in_tooltip', 'option');
                                if (!empty($allin_tooltip)) { ?>
                                    <a class="beton-popover text-success" tabindex="0" role="button"
                                        data-bs-toggle="popover" data-bs-trigger="focus" title="Uitvoering"
                                        data-bs-placement="top" data-bs-content="<?php echo esc_html($allin_tooltip); ?>"
                                        style="margin-left: 1px;">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <mask id="mask0_67_23_3" style="mask-type:alpha" maskUnits="userSpaceOnUse"
                            ...
                            <label class="bpc-uitv-card">
                                ...
                                <div class="bpc-uitv-top">
                                    ...
                                    <div class="bpc-uitv-price">Prijs = <span
                                            id="allIn_formatted_clone"><?php echo wc_price(330); ?></span>
                                    </div>
                                </div>
                    ...
                    <div class="bpc-section" id="bpc-section-vlindervloer">
                        ...
                        <div class="bpc-section-head">
                            ...
                            <div class="bpc-step-input-icon">
                                <?php $vlindervloer_tooltip = get_field('opties_vlindervloer_tooltip', 'option');
                    ...
                    <div class="bpc-section" id="bpc-section-datum">
                        ...
                        <div class="bpc-section-head">
                            ...
                            <div class="bpc-step-input-icon">
                                <?php if (!empty($dateTooltip)) { ?>
                                    <a class="beton-popover text-success" tabindex="0" role="button"
                                        data-bs-toggle="popover" data-bs-trigger="focus" title="Gewenste leveringsdatum"
                                        data-bs-placement="top" data-bs-content="<?php echo $dateTooltip; ?>"
                                        style="margin-left: 1px;">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <mask id="mask0_67_23_3" style="mask-type:alpha" maskUnits="userSpaceOnUse"
