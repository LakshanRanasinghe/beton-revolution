...
<main id="primary" class="beton-page-content site-main container page404">
	...
	<section class="error-404 not-found py-8">
		<header class="page-header">
			<h1 class="page-title oswald-500 display-3 text-40 m-0 text-black text-uppercase mb-1">
				<?php esc_html_e('Oeps! Die pagina kon niet worden gevonden.', 'beton'); ?>
			</h1>
		...
		<div class="page-content" style="min-height:300px;">
			<p><?php esc_html_e('Het lijkt erop dat er op deze locatie niets is gevonden. Probeer misschien een van de onderstaande links of gebruik de zoekfunctie.', 'beton'); ?>
			</p>
